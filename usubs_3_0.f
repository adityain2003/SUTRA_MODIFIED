...
C                                                                        UNSAT.........3500
!     ADITYA
!     SWRES,AA AND VN VALUES ARE NOW ASSIGNED FROM ARRAYS
      SWRES=SWRES_NREG(KREG)
      AA=AA_NREG(KREG)
      VN=VN_NREG(KREG)
...
C                                                                        UNSAT.........7100
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  UNSAT.........7200
!     THREE PARAMETER MODEL OF VAN GENUCHTEN(1980)                       UNSAT.........7300
      SWRM1=1.E0-SWRES                                                   UNSAT.........7400
      AAPVN=1.E0+(AA*(-PRES))**VN                                        UNSAT.........7500
      VNF=(VN-1.E0)/VN                                                   UNSAT.........7600
      AAPVNN=AAPVN**VNF                                                  UNSAT.........7700
      SW=DBLE (SWRES+SWRM1/AAPVNN)                                      UNSAT.........7800
!      ADITYA
!            WRITE(*,*) 'SW=',SW,'K_REG=',KREG
!      WRITE(*,*) KREG,SWRES_NREG(KREG),AA_NREG(KREG),VN_NREG(KREG)
!      WRITE(*,*) 'UNSAT ','PRES=',PRES,'DSWDP=',DSWDP,'K_REG=',KREG
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  UNSAT.........7900
C*********************************************************************** UNSAT.........8000
C*********************************************************************** UNSAT.........8100
C                                                                        UNSAT.........8200
...
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  UNSAT.........9700
      ...
      DSWDP=DBLE (DNUM/DNOM)                                            UNSAT........10000
!      ADITYA
...
C     GENERAL RELATIVE PERMEABILITY MODEL FROM VAN GENUCHTEN(1980)       RKSAT.........6600
      ...
      RELK=DBLE (SQRT(SWSTAR)*                                          RKSAT.........7000
     1                   (1.E0-(1.E0-SWSTAR**(1.E0/VNF))**(VNF))**2)     RKSAT.........7100
!      ADITYA
!            WRITE(*,*) 'RKSAT ','RELK=',RELK,'K_REG=',KREG
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  RKSAT.........7200
C*********************************************************************** RKSAT.........7300
C*********************************************************************** RKSAT.........7400
C                                                                        RKSAT.........7500
